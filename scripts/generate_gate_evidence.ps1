...
if (-not $OutPrefix) {
    ...
    $OutPrefix = "roadmap_ctp/QA_EVIDENCE_W14_$timestamp"
}

$scriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$rootDir = Split-Path -Parent $scriptDir

Write-Host "=== Gate-Evidence Generator (W14) ===" -ForegroundColor Cyan
...
$jsonData = @{
    metadata = @{
        ...
        evidence_level = "release-hardened W14"
        evidence_version = "4.0"  # W14: Megapack - SU-006, SU-009, UX-003 Erweiterungen
        toolchain = @{
            python = "3.11.14"
            pytest = "9.0.2"
            platform = "win32"
...
**Evidence Level:** Release-Hardened W14
**Evidence Version:** 4.0 (W14: Megapack - SU-006, SU-009, UX-003)
...
**Generated by:** AI-3 (GLM 4.7) QA Cell - **Automated W14**
